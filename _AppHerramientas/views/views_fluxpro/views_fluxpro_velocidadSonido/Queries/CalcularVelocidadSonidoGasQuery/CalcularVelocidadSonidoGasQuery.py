...
def FluxProVel_view(request):
    return render(request, "_AppHerramientas/templates_fluxpro/templates_fluxpro_velocidadSonido/index.html", {"gases": GASES, "active_section": "fluxpro_velocidadSonido"})
